export function MegaphoneIcon({ className = "" }) {
  return (
    ...
    >
      ...
      <path d="M15 7l6 3-6 3V7z" />
      <path d="M15 7l-8 4v2l8 4V7z" />
    </svg>
  );
}
...
export function GraduationCapIcon({ className = "" }) {
  return (
    ...
    >
      ...
      <path d="M6 12v5c0 .5.2 1 .6 1.3 1 .7 2.7 1.7 5.4 1.7s4.4-1 5.4-1.7c.4-.3.6-.8.6-1.3v-5" />
    </svg>
  );
}
...
export function HandshakeIcon({ className = "" }) {
  return (
    ...
    >
      ...
      <path d="M15 9l2 2" />
      <path d="M9 7l2 2" />
      <path d="M5 13l4 4a3 3 0 0 0 4.2 0l1.6-1.6a3 3 0 0 0 0-4.2l-4-4" />
      <path d="M19 7l-2 2" />
    </svg>
  );
}
...
export function LinkedInIcon({ className = "" }) {
  return (
    ...
    >
      ...
      <path d="M10 9h4v11h-4V9z" />
      <path d="M14 12c.6-1.5 2-3 4-3 2.2 0 2.9 1.5 2.9 3.8V20H17V12z" />
    </svg>
  );
}
...
export function UsersIcon({ className = "" }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M17 21a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4" />
